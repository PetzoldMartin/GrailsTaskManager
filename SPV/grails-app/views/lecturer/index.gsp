		...
		<div id="list-lecturer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'lecturer.name.label', default: 'Name')}" />
				...
				<g:each in="${lecturerInstanceList}" status="i" var="lecturerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${lecturerInstance.id}">${fieldValue(bean: lecturerInstance, field: "name")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${lecturerInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
