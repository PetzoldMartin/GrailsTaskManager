		...
		<div id="list-customer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="maritalStatus" title="${message(code: 'customer.maritalStatus.label', default: 'Marital Status')}" />
				...
				<g:each in="${customerInstanceList}" status="i" var="customerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${customerInstance.id}">${fieldValue(bean: customerInstance, field: "birthday")}</g:link></td>
						...
						<td>${fieldValue(bean: customerInstance, field: "maritalStatus")}</td>
