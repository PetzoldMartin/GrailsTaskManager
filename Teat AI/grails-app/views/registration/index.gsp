		...
		<div id="list-registration" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="lastUpdated" title="${message(code: 'registration.lastUpdated.label', default: 'Last Updated')}" />
				...
				<g:each in="${registrationInstanceList}" status="i" var="registrationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${registrationInstance.lastUpdated}" /></td>
